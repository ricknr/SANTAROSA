...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description" content="SANTA ROSA">
    <meta name="author" content="Ricardo Nuñez">
    <meta name="keyword" content="Parque Funerario Santa Rosa">
    <link rel="shortcut icon" href="${pageContext.request.contextPath}/dist/img/cementerio_icono.png">
...
<div class="wrapper">
  ...
  <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="${pageContext.request.contextPath}/dist/img/cementerio_icono.png" alt="AdminLTELogo" height="60" width="60">
  </div>
